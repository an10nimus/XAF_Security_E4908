...
namespace Microsoft.Extensions.DependencyInjection {
	using BlazorApplication.WebAssembly;
	using Microsoft.AspNetCore.Components.WebAssembly.Hosting;

	public static class SecurityProviderExtensions {
		public static IServiceCollection AddXafSecurity(this WebAssemblyHostBuilder builder) {
			return builder.Services.AddSingleton<XpoDataStoreProviderService>()
				.AddScoped<SecurityProvider>();
		}
		public static IServiceCollection AddSecuredTypes(this WebAssemblyHostBuilder builder, params Type[] types) {
			return builder.Services.Configure<SecurityOptions>(options => {
